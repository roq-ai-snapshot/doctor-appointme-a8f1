  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover a new way of scheduling with Doctor Appointment System - easy, quick, and efficient. Empowering patients and doctors alike, every day."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N0b3J8ZW58MHx8fHwxNjk4Mzk5MTUyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover a new way of scheduling with Doctor Appointment System - easy, quick, and efficient. Empowering patients and doctors alike, every day.`}
            </Text>
            <Box
