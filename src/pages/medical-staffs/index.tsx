...
import { useRoqClient, useMedicalStaffFindManyWithCount } from 'lib/roq';
...
export function MedicalStaffListPage(props: MedicalStaffListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useMedicalStaffFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.medical_staff.delete({ where: { id } });
      await mutate();
    } catch (error) {
