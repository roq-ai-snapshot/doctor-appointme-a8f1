...
function AppointmentViewPage() {
  ...
  const queryParams = useMemo<{
    include: { user: boolean; healthcare_provider: boolean; clinic: boolean; insurance_provider: boolean };
  }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'healthcare_provider', 'clinic', 'insurance_provider'],
          id,
        },
        'appointment',
      ),
                  ...
                  <FormListItem
                    ...
                    text={
                      <Link as={NextLink} href={`/healthcare-providers/view/${data?.healthcare_provider?.id}`}>
                        {data?.healthcare_provider?.email + ''}
                      </Link>
                    }
                  />
                )}
